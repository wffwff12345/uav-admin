<template>
  <div class="video-box">
    <video :id="videoID" class="vjs-custom-player video-js" controls muted preload="auto" autoplay :title=title></video>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    playerSrc: {
      required: true,
      type: String,
      default: 'http://223.112.179.125:23081/hls/stream2.m3u8',
    },
