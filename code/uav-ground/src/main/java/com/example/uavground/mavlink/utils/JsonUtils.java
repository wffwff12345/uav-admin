package com.example.uavground.mavlink.utils;
...
public class JsonUtils {
    ...
    /**
     * 根据Json字符串，转换为List<T>对象
     *
     * @param jsonString Json字符串
     * @param typeReference 指定TypeReference
     * @param <T> 指定Type
     * @return List<T>对象
     */
    public static <T> List<T> toList(final String jsonString, TypeReference<List<T>> typeReference) {
        List<T> list = null;
        try {
            list = objectMapper.readValue(jsonString, typeReference);
