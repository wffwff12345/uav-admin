...
import com.example.uavground.mavlink.WebSocketCode.WebSocketCode;
    ...
    public WebSocketHandler webSocketHandler() {
        return new TextWebSocketHandler() {
            ...
            protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
                ...
                WebSocketCode webSocketCode = WebSocketCode.valueOf(message.getPayload().split("#")[0]);
                webSocketCode.callback(message.getPayload().split("#")[1]);
            }
