 ...
 */
@RestController
@RequestMapping("/app/task/item")
public class AppUavVehicleTaskItemController extends BaseController
{
    @Autowired
    ...
    public AjaxResult addList(@RequestBody List<UavVehicleTaskItem> uavVehicleTaskItems)
    {
        return toAjax(uavVehicleTaskItemService.insertUavVehicleTaskItems(uavVehicleTaskItems));
    }
