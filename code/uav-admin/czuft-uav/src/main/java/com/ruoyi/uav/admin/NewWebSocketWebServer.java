...
@Component
@Slf4j
@ServerEndpoint("/websocket/new/web/{macId}")
public class NewWebSocketWebServer {
    ...
    public static CopyOnWriteArraySet<NewWebSocketWebServer> webSocketSet = new CopyOnWriteArraySet<>();
